<template>
    ...
    >
        ...
        <!-- Сохраненные данные -->
        <div class="text-h6 text-weight-bold text-white q-mb-md">Сохраненные данные</div>
            ...
            <div class="col-12 col-md-4">
                <q-card class="dictionary-card">
                    ...
                    <q-card-section class="q-pa-md">
                        <q-list>
                            <q-item
                                v-for="item in meta.addresses"
                                :key="item.id"
                                class="q-mb-xs rounded-item"
                            >
                                <q-item-section avatar>
                                    <q-avatar
                                        icon="location_on"
            ...
            <div class="col-12 col-md-4">
                <q-card class="dictionary-card">
                    <q-card-section class="dictionary-header bg-secondary">
                        <div class="row justify-between items-center">
                            ...
                            <q-btn
                                ...
                                icon="add"
                                color="white"
                                @click="showAddDialog('payment_types')"
                            />
                        </div>
                    </q-card-section>
                    ...
                    <q-card-section class="q-pa-md">
                        <q-list>
                            <q-item
                                v-for="item in meta.payment_types"
                                :key="item.id"
                                class="q-mb-xs rounded-item"
                            >
                                <q-item-section avatar>
                            ...
                            <q-item
                                v-if="!meta.payment_types.length"
                                class="text-center q-py-md"
                            >
                                <q-item-section>
                                    <q-icon
